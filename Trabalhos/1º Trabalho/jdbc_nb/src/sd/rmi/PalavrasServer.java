...
public class PalavrasServer {  //faz o registo do registo nome no binder
    ...
    public static void main(String args[]) {
		...
		if (args.length !=5) { // obrigar à presenca de um argumento
		    System.out.println("Usage: java sd.rmi.PalavrasServer registryPort registryHost databaseName user password");
		    System.exit(1);
		}
		...
		try {
		    ...
		    Palavras obj= new PalavrasImpl(args[1], args[2], args[3], args[4]);       
