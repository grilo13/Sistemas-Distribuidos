...
public class OperacoesClient {
	 ...
	 */
	 public static void menu(Operacoes obj) throws RemoteException {
		 while (true) {
	            System.out.print("\n------------MENU------------\nSelecione a opção que deseja:\n"
	                    ...
	                    + "6- Listar nº total de vacinados por tipo de vacina e nº de casos com efeitos secundários por tipo de vacina\n"
	                    + "0- Sair\n>> ");
	            ...
	            switch (menuChoice) {
	                ...
	                case "2":
	                	...
	                	while(auxiliar == 0) {
	                		System.out.println("Insira o número do centro que quer ver a fila de espera: ");
		                	Scanner scanner2 = new Scanner(System.in);
		                	int verCentro = scanner.nextInt();
		                	System.out.println("A verificar o centro " + verCentro + " ....");
	                ...
	                case "3":
	                	...
	                	System.out.println("Insira o seu nome, idade e genero: (nome, idade, genero(Masculino ou Feminino))");
	...
	public static void main(String args[]) {
		...
		if (args.length !=2) { // requer 2 argumentos
		    System.out.println
			("Usage: java sd.rmi.OperacoesClient registryHost registryPort");
		    System.exit(1);
		}
		regHost= args[0];
		regPort= args[1];
		...
		try {
		    ...
		    Operacoes obj = (Operacoes) java.rmi.Naming.lookup("rmi://" + regHost +":"+regPort +"/Operacoes");
